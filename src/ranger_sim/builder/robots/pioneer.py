...
class Mycar(GroundRobot):
    ...
    def __init__(self, name = None, debug = False):#change the debug model to false because I don't want to use keyboard control the robot
        ...
        GroundRobot.__init__(self, 'ranger_sim/robots/pioneer.blend', name)
        self.properties(classpath = "ranger_sim.robots.pioneer.Pioneer")
        ...
        self.sick.translate(0.0,0.0,1.5)
