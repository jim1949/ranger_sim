...
def callback3(msg):#scan and collision avoidance.
    global sick_readings
    global car_x,car_y,car_ctrltheta
    ranges=msg.ranges
    ...
    sick_readings.write("%2.4f, %2.4f, %2.4f, "%(car_x,car_y,car_theta))
    sick_readings.write("\n")
    # print("nearest reading: %2.2f" %nearest_reading)


sick_readings = open("sick_data_posorientaion1.dat", "a")
